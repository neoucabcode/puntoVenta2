...
**Nota:** Los módulos 1-8 describen responsabilidades de negocio. El módulo 9 (seguridad) y los roles asociados se detallan en `05-roles-y-permisos.md`.
...
### Objetivo
Controlar acceso, permisos y trazabilidad. *(Responsabilidades de negocio; el diseño de roles/permisos queda en `05`)*
