-- patch_08_ordenar_productos_rpc.sql
-- Agrega parámetro p_order_by a buscar_productos para ordenar resultados
-- de forma segura (whitelist). Valor inválido cae a 'nombre ASC'.
-- Backward compatible: parámetro opcional con default.
